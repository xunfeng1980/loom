...
- [ ] **Phase 5: FSST L2 Kernel and Full Verification** - Implement the FSST L2 kernel and run the row-for-row verification harness across all encodings — the MVP0 acceptance gate
...
**Success Criteria** (what must be TRUE):
  ...
  5. `[profile.release] panic = "abort"` and `#[global_allocator] static A: System = System;` are present and verified in CI
**Plans**: TBD
...
|-------|----------------|--------|-----------|
| 1. Scaffold and FFI Boundary | 0/TBD | Not started | - |
