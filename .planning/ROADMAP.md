...
- [ ] **Phase 11: Distribution Container v0** - Introduce a versioned `LMC1` container with feature flags and a section directory around existing `LMP1`/`LMT1` payloads (executing, 2/4 plans complete)
...
| 11. Distribution Container v0 | 2/4 | Executing | - |
