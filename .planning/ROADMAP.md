...
- [ ] **Phase 18: Complete Vortex Reader** - Planned expansion from Phase 15's narrow real-ingress slice into a complete, isolated, fail-closed Vortex file/container reader before solver-backed verification and engine-integrated native execution
...
**Status:** Planned. See `.planning/phases/18-complete-vortex-reader/18-RESEARCH.md`, `18-CONTEXT.md`, and plans `18-01` through `18-05`.
...
- [ ] 18-01-PLAN.md - Reader facts contract and dependency boundary
- [ ] 18-02-PLAN.md - Recursive layout/dtype/segment inspection
- [ ] 18-03-PLAN.md - Supported single-column conversion matrix
- [ ] 18-04-PLAN.md - Supported struct/table conversion
...
| 18. Complete Vortex Reader | 0/5 | Planned | - |
