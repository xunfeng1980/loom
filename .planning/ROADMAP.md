...
- [ ] **Phase 11: Distribution Container v0** - Introduce a versioned `LMC1` container with feature flags and a section directory around existing `LMP1`/`LMT1` payloads (executing, 1/4 plans complete)
...
| 11. Distribution Container v0 | 1/4 | Executing | - |
