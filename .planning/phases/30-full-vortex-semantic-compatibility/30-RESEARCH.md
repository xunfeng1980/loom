# Phase 30: Full Vortex Semantic Compatibility - Research
...
Phase 30 should not mean "blindly accept every Vortex file." It should mean a
...
1. Create a Phase 30 compatibility matrix/report model in `loom-vortex-ingress`
...
Phase 30 must preserve this distinction. Compatibility may be interpreter-only,
but native-supported rows need actual production-lowering and ExecutionEngine
evidence.

## Recommended Phase Shape

### Plan 30-01: Compatibility Matrix Contract
...
### Plan 30-02: Matrix Fixture Assertions and Drift Gate
...
### Plan 30-03: Nullable Primitive Artifact Semantics
...
### Plan 30-04: Structured Encoding Semantics
...
- Phase 30 proceeds without Phase 29 dual-query evidence. This is acceptable
