# Phase 30: Full Vortex Semantic Compatibility - Context
...
Phase 30 targets full Vortex semantic compatibility as a staged compatibility
...
- Produce a Phase 30 compatibility matrix/report that distinguishes accepted,
...
- Accepted tradeoff: Phase 30 starts without Phase 29 StarRocks/DuckDB
...
- Accepted tradeoff: The first Phase 30 pass may complete "full semantic
...
- Keep the Phase 29 skip/defer visible in Phase 30 planning and final reporting.
- Treat the recent native zero-buffer fix as a regression guard: Phase 30 must
