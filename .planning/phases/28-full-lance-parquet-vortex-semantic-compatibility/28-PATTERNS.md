...
The focused Phase 28 gate should prove:

1. `28-CONTEXT.md`, `28-RESEARCH.md`, `28-PATTERNS.md`, and final report exist.
...
- Phase 29 skip/defer reduces second-host validation. Phase 28 must document that gap instead of compensating with broader claims.
