# Phase 30: StarRocks + DuckDB Dual Query Surface - Context
...
Phase 30 proves that the same Phase 29 Iceberg-bound, verifier-backed Loom
...
- `scripts/iceberg-binding-test.sh` is the closest focused-gate analog for
  Phase 30 ordering and scope-creep guards.
...
- Workspace manifests: root `Cargo.toml` and any Phase 30 adapter crate
  manifest.
- Phase 29 binding input: `crates/loom-iceberg-binding`.
...
- Reuse the Phase 29 accepted fixture as the shared table binding input.
