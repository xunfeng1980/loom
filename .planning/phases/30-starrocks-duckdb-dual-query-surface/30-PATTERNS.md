...
| `scripts/dual-query-surface-test.sh` | Focused Phase 30 gate, dependency/API boundary checks, DuckDB query check, optional StarRocks runtime smoke. | `iceberg-binding-test.sh`, `duckdb-smoke-test.sh` |
| `.planning/phases/30-starrocks-duckdb-dual-query-surface/30-DUAL-QUERY-SURFACE-REPORT.md` | Final evidence report with engine comparison, current-phase tradeoffs, release gate evidence, Phase 30 handoff. | `29-ICEBERG-BINDING-REPORT.md` |
...
1. Phase 29 accepted binding evidence still passes.
...
6. Main release gate order is Phase 29 Iceberg binding, Phase 30 dual query surface, then DuckDB smoke.
