...
provides:
  ...
  - Phase 28 Iceberg binding evidence report
...
key-decisions:
  ...
  - "The Phase 28 report and gate continue to record no default official iceberg crate dependency."
...
# Phase 28 Plan 04: Iceberg Mismatch and Report Summary
...
- Wrote `28-ICEBERG-BINDING-REPORT.md` with binding schema, evidence, current-phase tradeoffs, non-goals, no-default-`iceberg` decision, and Phase 29 handoff.
...
- `.planning/phases/28-iceberg-ref-table-binding/28-ICEBERG-BINDING-REPORT.md` - Phase 28 binding evidence report.
...
- Keep `scripts/mvp0-verify.sh` unwired until Plan 28-05, while making the focused gate authoritative for Plan 28-04.
...
- **Files modified:** `.planning/phases/28-iceberg-ref-table-binding/28-ICEBERG-BINDING-REPORT.md`
...
- `test -f .planning/phases/28-iceberg-ref-table-binding/28-ICEBERG-BINDING-REPORT.md` - passed
- `rg -q "Binding Schema" .planning/phases/28-iceberg-ref-table-binding/28-ICEBERG-BINDING-REPORT.md` - passed
- `rg -q "Mismatch Fail-Closed Matrix" .planning/phases/28-iceberg-ref-table-binding/28-ICEBERG-BINDING-REPORT.md` - passed
...
Plan 28-05 can wire the focused Iceberg binding gate into `scripts/mvp0-verify.sh` after Phase 27 and before downstream query-surface work. The binding report records that evidence is still focused-gate-only until that wiring happens.

## Self-Check: PASSED

- Created files exist: mismatch test, five mismatch fixtures, Phase 28 binding report, and this summary.
