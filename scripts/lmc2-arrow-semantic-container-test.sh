...
check_marker "LMC2(LMA1)" crates/loom-source-ingress/src/lib.rs "source emission display"
check_marker "LMC2-wrapped LMA1 semantic emission" crates/loom-parquet-ingress/src/source_contract.rs "Parquet LMC2 report wording"
check_marker "LMC2-wrapped LMA1 semantic emission" crates/loom-lance-ingress/src/source_contract.rs "Lance LMC2 report wording"
check_marker "LMC2-wrapped LMA1 semantic emission" crates/loom-vortex-ingress/src/source_contract.rs "Vortex LMC2 report wording"
